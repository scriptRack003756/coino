...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("CNO");
    case mBTC: return QString("mCNO");
    case uBTC: return QString::fromUtf8("μCNO");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("Coinos"));
    case mBTC: return QString(QObject::tr("Milli-Coinos (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-Coinos (1 / 1,000,000)"));
    default: return QString("???");
    }
}
